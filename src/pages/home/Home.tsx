...
const footerNavigation = {
  solutions: [
    { name: "Hosting", to: "#" },
    { name: "Data Services", to: "#" },
    { name: "Uptime Monitoring", to: "#" },
    { name: "Enterprise Services", to: "#" },
  ],
  support: [
    { name: "Pricing", to: "#" },
          ...
          <>
              ...
              <div className="flex h-16 justify-between">
                <div className="flex px-2 lg:px-0">
                  <div className="flex flex-shrink-0 items-center">
                    <img className="h-12 w-auto" src="https://gemkox-spaces.nyc3.cdn.digitaloceanspaces.com/jit-vcs/JIT.svg" alt="Your Company" />
                  </div>
                      ...
                      {navigation.map((item) => {
                        return (
                          <NavLink
                            ...
                            className={({ isActive }) =>
                              isActive
                                ? classNames("border-primary-500", "inline-flex items-center border-b-2  px-1 pt-1 text-sm font-medium text-gray-900")
                                : classNames("border-transparent", "inline-flex items-center border-b-2  px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700")
                            }>
                            {item.name}
                          </NavLink>
                        );
            ...
            <Disclosure.Panel className="lg:hidden">
              <div className="space-y-1 pb-3 pt-2">
                ...
                <Disclosure.Button as="a" href="" className="block border-l-4 border-primary-500 bg-primary-50 py-2 pl-3 pr-4 text-base font-medium text-primary-700">
                  About
                </Disclosure.Button>
                <Disclosure.Button
                  as="a"
